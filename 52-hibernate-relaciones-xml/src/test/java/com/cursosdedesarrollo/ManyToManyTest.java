 ...
 *    - Solo Producto conoce a Etiqueta (tiene la tabla productos_etiquetas).
 ...
 *    - Pelicula es el dueño (tabla actores_peliculas).
 *    - Actor tiene inverse="true" como lado inverso.
