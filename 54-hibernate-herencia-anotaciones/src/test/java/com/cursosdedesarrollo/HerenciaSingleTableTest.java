 ...
 *     tipo    VARCHAR(3) NOT NULL,   ← "CLI" o "EMP"
...
public class HerenciaSingleTableTest {
    ...
    public void subclasesSeGuardanEnMismaTabla() {
        ...
        // Consulta polimórfica: recuperar por la superclase devuelve la subclase real
    ...
    public void consultarSoloUnaSubclase() {
        ...
        // Solo los Empleados — Hibernate añade WHERE tipo='EMP' automáticamente
    ...
    public void instanceofTrabajaConPolimorfismo() {
        ...
        Session s2 = HibernateUtil.getSessionFactory().openSession();
        // Cargar por la superclase → Hibernate devuelve la subclase correcta
    ...
    public void columnaDiscriminadoraEsTransparente() {
        // El programador nunca escribe la columna "tipo" — Hibernate la gestiona
        Session s = HibernateUtil.getSessionFactory().openSession();
        Transaction t = s.beginTransaction();
