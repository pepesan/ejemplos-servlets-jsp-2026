 ...
 *
 * Al guardar un Coche Hibernate hace INSERT en vehiculos + INSERT en coches.
 * Al leer polimórficamente hace LEFT JOIN vehiculos + coches + motos.
 */
public class HerenciaJoinedTest {
    ...
    public void consultaPolimorficaHaceJoin() {
        ...
        Session s2 = HibernateUtil.getSessionFactory().openSession();
        // "from Vehiculo" hace LEFT JOIN coches + motos; devuelve Coche y Moto
    ...
    public void columnasDeSubclasePuedenSerNotNull() {
        // A diferencia de SINGLE_TABLE, las columnas propias de subclase
        // están en tablas separadas y pueden ser NOT NULL
        Session s = HibernateUtil.getSessionFactory().openSession();
        Transaction t = s.beginTransaction();
