...
class Html {
    ...
    static void cabecera(PrintWriter out, String titulo) {
        ...
        out.println("td:first-child{white-space:nowrap}");
        ...
        out.println("button{background:#45475a;color:#cdd6f4;border:none;padding:.3em .9em;"
                + "border-radius:3px;cursor:pointer;font-family:monospace;font-size:.9em}");
        out.println("button:hover{background:#585b70}");
        out.println("</style></head><body>");
    }

    static void nav(PrintWriter out, String activa) {
        out.println("<div class='nav'>");
        out.println("<a href='/'>Inicio</a>");
        out.println("<a href='/sesion'" + ("sesion".equals(activa) ? " style='color:#89b4fa'" : "") + ">Inspección</a>");
        out.println("<a href='/contador'" + ("contador".equals(activa) ? " style='color:#89b4fa'" : "") + ">Contador</a>");
        out.println("<a href='/carrito'" + ("carrito".equals(activa) ? " style='color:#89b4fa'" : "") + ">Carrito</a>");
        out.println("</div>");
    }
