 ...
 *
 * Requisito previo: servidor PostgreSQL en ejecución.
 *   cd docker && docker compose up -d postgres
 *
 * Credenciales (hibernate.cfg.xml):
 *   host: localhost:5432  BD: cursosdb  usuario: curso  contraseña: curso123
 */
@Ignore("Requiere PostgreSQL en marcha: cd docker && docker compose up -d postgres")
public class ProductoPostgresTest {
