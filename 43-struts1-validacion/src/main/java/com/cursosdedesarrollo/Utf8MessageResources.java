...
/**
 * Carga ApplicationResources.properties como UTF-8 en lugar de ISO-8859-1.
 *
 * Struts 1.x usa PropertyResourceBundle(InputStream) que lee ISO-8859-1 por defecto.
 * Esta subclase sobreescribe loadLocale() para pasarle un InputStreamReader UTF-8.
 */
