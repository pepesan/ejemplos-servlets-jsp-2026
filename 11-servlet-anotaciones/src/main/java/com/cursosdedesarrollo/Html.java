...
class Html {
    ...
    static void cabecera(PrintWriter out, String titulo) {
        ...
        out.println(".nav a{color:#a6adc8;text-decoration:none;margin-right:1em}.nav a:hover{color:#cdd6f4}");
    ...
    static void nav(PrintWriter out) {
        ...
        out.println("<a href='/hola'>hola</a>");
        out.println("<a href='/config'>config (initParams)</a>");
        out.println("<a href='/precargado'>precargado (loadOnStartup)</a>");
        out.println("<a href='/perezoso'>perezoso (lazy)</a>");
        out.println("<a href='/inicio'>inicio (alias)</a>");
        out.println("</div>");
    }
